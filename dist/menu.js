define("bui/menu", ["bui/common", "bui/menu/menu", "bui/menu/menuitem", "bui/menu/contextmenu", "bui/menu/popmenu", "bui/menu/sidemenu"], function(require, exports, module) {
  /**
...
define("bui/menu/menu", ["bui/common"], function(require, exports, module) {
  /**
   * @fileOverview 菜单基类
...
define("bui/menu/menuitem", ["bui/common"], function(require, exports, module) {
  /**
   * @fileOverview 菜单项
   * @ignore
   */
...
define("bui/menu/contextmenu", ["bui/common", "bui/menu/menuitem", "bui/menu/popmenu", "bui/menu/menu"], function(require, exports, module) {
  /**
...
define("bui/menu/popmenu", ["bui/common", "bui/menu/menu"], function(require, exports, module) {
  /**
...
define("bui/menu/sidemenu", ["bui/common", "bui/menu/menu"], function(require, exports, module) {
  /**
   * @fileOverview 侧边栏菜单
   * @author dxq613@gmail.com
   * @ignore

define("bui-data/1.1.0/index-debug", ["jquery", "bui-common/1.1.0/common-debug", "bui-data/1.1.0/src/sortable-debug", "bui-data/1.1.0/src/proxy-debug", "bui-data/1.1.0/src/abstractstore-debug", "bui-data/1.1.0/src/store-debug", "bui-data/1.1.0/src/node-debug", "bui-data/1.1.0/src/treestore-debug"], function(require, exports, module) {
  ...
  BUI.mix(Data, {
    ...
    Store: require("bui-data/1.1.0/src/store-debug"),
    Node: require("bui-data/1.1.0/src/node-debug"),
    TreeStore: require("bui-data/1.1.0/src/treestore-debug")
  });
  module.exports = Data;
});
define("bui-data/1.1.0/src/sortable-debug", [], function(require, exports, module) {
  /**
   * @fileOverview 可排序扩展类
   * @ignore
   */
...
define("bui-data/1.1.0/src/proxy-debug", ["jquery", "bui-data/1.1.0/src/sortable-debug"], function(require, exports, module) {
  var $ = require("jquery"),
    Sortable = require("bui-data/1.1.0/src/sortable-debug");
  /**
   * 数据代理对象，加载数据,
...
define("bui-data/1.1.0/src/abstractstore-debug", ["jquery", "bui-common/1.1.0/common-debug", "bui-data/1.1.0/src/proxy-debug", "bui-data/1.1.0/src/sortable-debug"], function(require, exports, module) {
  /**
...
define("bui-data/1.1.0/src/store-debug", ["jquery", "bui-data/1.1.0/src/proxy-debug", "bui-data/1.1.0/src/abstractstore-debug", "bui-data/1.1.0/src/sortable-debug", "bui-common/1.1.0/common-debug"], function(require, exports, module) {
  /**
   * @fileOverview 数据缓冲对象
...
define("bui-data/1.1.0/src/node-debug", ["jquery", "bui-common/1.1.0/common-debug"], function(require, exports, module) {
  /**
...
define("bui-data/1.1.0/src/treestore-debug", ["jquery", "bui-common/1.1.0/common-debug", "bui-data/1.1.0/src/node-debug", "bui-data/1.1.0/src/proxy-debug", "bui-data/1.1.0/src/abstractstore-debug", "bui-data/1.1.0/src/sortable-debug"], function(require, exports, module) {
  /**

define("bui-editor/1.1.0/index-debug", ["bui-common/1.1.0/common-debug", "jquery", "bui-form/1.1.0/index-debug", "bui-overlay/1.1.0/index-debug", "bui-list/1.1.0/index-debug", "bui-data/1.1.0/index-debug"], function(require, exports, module) {
  var BUI = require("bui-common/1.1.0/common-debug"),
    Form = require("bui-form/1.1.0/index-debug"),
    Editor = BUI.namespace('Editor');
  BUI.mix(Editor, {
    Editor: require("bui-editor/1.1.0/src/editor-debug"),
    RecordEditor: require("bui-editor/1.1.0/src/record-debug"),
    DialogEditor: require("bui-editor/1.1.0/src/dialog-debug")
  });
  return Editor;
});
define("bui-editor/1.1.0/src/editor-debug", ["bui-common/1.1.0/common-debug", "jquery", "bui-overlay/1.1.0/index-debug"], function(require, exports, module) {
  /**
   * @ignore
   * @fileOverview 编辑器
  ...
  Mixin = require("bui-editor/1.1.0/src/mixin-debug");
  /**
...
define("bui-editor/1.1.0/src/mixin-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-editor/1.1.0/src/record-debug", ["bui-common/1.1.0/common-debug", "jquery", "bui-overlay/1.1.0/index-debug"], function(require, exports, module) {
  /**
   * @fileOverview 对象编辑器
   * @ignore
   */
...
define("bui-editor/1.1.0/src/dialog-debug", ["jquery", "bui-overlay/1.1.0/index-debug", "bui-common/1.1.0/common-debug"], function(require, exports, module) {
  /**

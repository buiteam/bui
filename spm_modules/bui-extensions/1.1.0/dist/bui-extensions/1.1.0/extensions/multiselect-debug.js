define("bui-extensions/1.1.0/extensions/multiselect-debug", ["bui-common/1.1.0/common-debug", "jquery", "bui-form/1.1.0/index-debug", "bui-overlay/1.1.0/index-debug", "bui-list/1.1.0/index-debug", "bui-data/1.1.0/index-debug", "bui-picker/1.1.0/index-debug"], function(require, exports, module) {
  /**
   * list左右选择
   * @fileOverview
   * @ignore
  ...
  var BUI = require("bui-common/1.1.0/common-debug"),
    Search = require("bui-extensions/1.1.0/extensions/search-debug"),
    multilist = require("bui-extensions/1.1.0/extensions/multiselect/multilist-debug"),
    multilistpicker = require("bui-extensions/1.1.0/extensions/multiselect/multilistpicker-debug"),
    multiselect = require("bui-extensions/1.1.0/extensions/multiselect/multiselect-debug");
...
define("bui-extensions/1.1.0/extensions/multiselect/multilist-debug", ["jquery", "bui-common/1.1.0/common-debug", "bui-list/1.1.0/index-debug", "bui-data/1.1.0/index-debug"], function(require, exports, module) {
  /**
   * list左右选择
   * @fileOverview
   * @ignore
  ...
  var MultiList = Component.Controller.extend({
    ...
    ATTRS: {
      ...
      tpl: {
        value: '<div class="row">' + '<div class="span5 ' + CLS_SOURCE + '"></div>' + '<div class="span2 bui-multilist-action centered">' + '<p><button  class="button button-small ' + CLS_BUTTON_RIGHT + '" type="button">&gt;&gt;</button></p>' + '<p><button  class="button button-small ' + CLS_BUTTON_LEFT + '" type="button">&lt;&lt;</button></p>' + '</div>' + '<div class="span5 ' + CLS_TARGET + '"></div>' + '</div>'
      }
    }
  }, {
    xclass: 'multilist'
...
define("bui-extensions/1.1.0/extensions/multiselect/multilistpicker-debug", ["jquery", "bui-overlay/1.1.0/index-debug", "bui-common/1.1.0/common-debug", "bui-picker/1.1.0/index-debug", "bui-list/1.1.0/index-debug", "bui-data/1.1.0/index-debug"], function(require, exports, module) {
  /**
   * @fileOverview 选择器
   * @ignore
   */
  var $ = require('jquery'),
    ...
    Mixin = require("bui-picker/1.1.0/index-debug").Mixin;
...
define("bui-extensions/1.1.0/extensions/multiselect/multiselect-debug", ["jquery", "bui-common/1.1.0/common-debug", "bui-list/1.1.0/index-debug", "bui-data/1.1.0/index-debug", "bui-overlay/1.1.0/index-debug", "bui-picker/1.1.0/index-debug", "bui-form/1.1.0/index-debug"], function(require, exports, module) {
  /**
   * list左右选择
   * @fileOverview
   * @ignore
  ...
  var MultiSelect = Component.Controller.extend({
    ...
    bindUI: function() {
      ...
      multilist.on('selected', function(ev) {
        var items = ev.items;
        return _self.fire('selected', {
          items: items
        });
      });
      multilist.on('unselected', function(ev) {
        var items = ev.items;
        return _self.fire('unselected', {
          items: items
        });
      })
    }

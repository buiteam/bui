define("bui-imgview/1.1.0/index-debug", ["jquery", "bui-common/1.1.0/common-debug", "bui-imgview/1.1.0/src/imgview-debug", "bui-imgview/1.1.0/src/viewcontent-debug", "bui-imgview/1.1.0/src/previewlist-debug", "bui-data/1.1.0/index-debug", "bui-toolbar/1.1.0/index-debug", "bui-graphic/1.1.0/index-debug", "bui-list/1.1.0/index-debug"], function(require, exports, module) {
  /**
  ...
  BUI.mix(ImgView, {
    ImgView: require("bui-imgview/1.1.0/src/imgview-debug"),
    ViewContent: require("bui-imgview/1.1.0/src/viewcontent-debug"),
    PreviewList: require("bui-imgview/1.1.0/src/previewlist-debug")
  });
  module.exports = ImgView;
});
define("bui-imgview/1.1.0/src/imgview-debug", ["jquery", "bui-common/1.1.0/common-debug", "bui-imgview/1.1.0/src/viewcontent-debug", "bui-imgview/1.1.0/src/previewlist-debug", "bui-data/1.1.0/index-debug", "bui-toolbar/1.1.0/index-debug", "bui-graphic/1.1.0/index-debug", "bui-list/1.1.0/index-debug"], function(require, exports, module) {
  /**
...
define("bui-imgview/1.1.0/src/viewcontent-debug", ["jquery", "bui-common/1.1.0/common-debug", "bui-graphic/1.1.0/index-debug"], function(require, exports, module) {
  /**
   * @fileOverview 图片预览
   * @ignore
   */
  var BUI = require("bui-common/1.1.0/common-debug"),
    Graphic = require("bui-graphic/1.1.0/index-debug");
  // 获取图片居中信息
...
define("bui-imgview/1.1.0/src/previewlist-debug", ["jquery", "bui-common/1.1.0/common-debug", "bui-data/1.1.0/index-debug", "bui-list/1.1.0/index-debug"], function(require, exports, module) {
  /**
   * @fileOverview 图片预览控件
   * @ignore
   */
  ...
  var PreviewList = BUI.Component.Controller.extend({
    ...
    _uiSetPageNum: function(pageNum) {
      var _self = this,
        ...
        alignType = _self.get('alignType');
      if (alignType == "height") {
        ul.clearQueue().animate({
          'marginTop': -pageNum * scrollSize
        }, scrollTime);
      } else if (alignType == "width") {
        ul.clearQueue().animate({
          'marginLeft': -pageNum * scrollSize
        }, scrollTime);
      }
    },
    /**

define("bui-menu/1.1.0/index-debug", ["bui-common/1.1.0/common-debug", "bui-menu/1.1.0/src/menu-debug", "bui-menu/1.1.0/src/menuitem-debug", "bui-menu/1.1.0/src/contextmenu-debug", "bui-menu/1.1.0/src/popmenu-debug", "bui-menu/1.1.0/src/sidemenu-debug"], function(require, exports, module) {
  /**
  ...
  BUI.mix(Menu, {
    Menu: require("bui-menu/1.1.0/src/menu-debug"),
    MenuItem: require("bui-menu/1.1.0/src/menuitem-debug"),
    ContextMenu: require("bui-menu/1.1.0/src/contextmenu-debug"),
    PopMenu: require("bui-menu/1.1.0/src/popmenu-debug"),
    SideMenu: require("bui-menu/1.1.0/src/sidemenu-debug")
  });
  Menu.ContextMenuItem = Menu.ContextMenu.Item;
  module.exports = Menu;
});
define("bui-menu/1.1.0/src/menu-debug", ["bui-common/1.1.0/common-debug"], function(require, exports, module) {
  /**
   * @fileOverview 菜单基类
...
define("bui-menu/1.1.0/src/menuitem-debug", ["bui-common/1.1.0/common-debug"], function(require, exports, module) {
  /**
   * @fileOverview 菜单项
   * @ignore
   */
...
define("bui-menu/1.1.0/src/contextmenu-debug", ["bui-common/1.1.0/common-debug", "bui-menu/1.1.0/src/menuitem-debug", "bui-menu/1.1.0/src/popmenu-debug", "bui-menu/1.1.0/src/menu-debug"], function(require, exports, module) {
  /**
...
define("bui-menu/1.1.0/src/popmenu-debug", ["bui-common/1.1.0/common-debug", "bui-menu/1.1.0/src/menu-debug"], function(require, exports, module) {
  /**
...
define("bui-menu/1.1.0/src/sidemenu-debug", ["bui-common/1.1.0/common-debug", "bui-menu/1.1.0/src/menu-debug"], function(require, exports, module) {
  /**
   * @fileOverview 侧边栏菜单
   * @author dxq613@gmail.com
   * @ignore

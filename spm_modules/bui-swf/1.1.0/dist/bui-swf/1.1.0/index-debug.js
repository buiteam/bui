define("bui-swf/1.1.0/index-debug", ["bui-swf/1.1.0/src/swf-debug", "jquery", "bui-common/1.1.0/common-debug", "bui-swf/1.1.0/src/ua/ua-debug"], function(require, exports, module) {
  module.exports = require("bui-swf/1.1.0/src/swf-debug");
});
define("bui-swf/1.1.0/src/swf-debug", ["jquery", "bui-common/1.1.0/common-debug", "bui-swf/1.1.0/src/ua/ua-debug"], function(require, exports, module) {
  /**
   * @ignore
  ...
  var $ = require("jquery"),
    ...
    FlashUA = require("bui-swf/1.1.0/src/ua/ua-debug"),
    UA = BUI.UA,
    JSON = BUI.JSON,
...
define("bui-swf/1.1.0/src/ua/ua-debug", [], function(require, exports, module) {
  /**
   * @ignore
   * Flash UA 探测
 ...
 */
  function getNumberVersion(ver) {
    var arr = typeof ver == 'string' ? getArrayVersion(ver) : ver,
      ret = ver;
    if (BUI.isArray(arr)) {

...
<?php include("../templates/header.php"); ?>
 <style>
  ...
  <div class="container">
    ...
    <script type="text/javascript" src="specs/issue-109-spec.js"></script>
    <script type="text/javascript" src="specs/issue-117-spec.js"></script>
    <script type="text/javascript" src="specs/issue-102-spec.js"></script>
        <script type="text/javascript" src="specs/issue-100-spec.js"></script>
    <script type="text/javascript" src="specs/issue-127-spec.js"></script><!---->

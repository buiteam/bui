define(['bui/calendar'], function(require){
  ...
  (function(){
    ...
    var Header = require('bui/calendar/header');
  ...
  (function(){
    ...
    var Calendar = require('bui/calendar/calendar');
  ...
  (function(){
    ...
    var DatePicker = require('bui/calendar/datepicker');
  ...
  (function(){
    ...
    var MonthPicker = require('bui/calendar/monthpicker');
